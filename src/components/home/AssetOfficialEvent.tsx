...
export const AssetOfficialEvent = (props: AssetOfficialProps) =>{
    ...
    return(
        // <div className="flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-copy border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins">
                ...
                <div className={`${props.category== 'Warsztaty' ? 'flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-copy border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins' : 
                                    props.category=='Sport' ? 'flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-blu border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins':
                                    props.category=='Koncert' ? 'flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-concert border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins':
                                    props.category=='Edukacja' ? 'flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-orange border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins':
                                    props.category=='Inne' ? 'flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-green border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins':
                                        'flex flex-col items-end justify-end font-poppins-bold text-gray-100 border-none  w-[22rem] h-[30rem] bg-green border border-card-cap-bg mr-5 ml-5 rounded-lg cursor-pointer font-poppins'
                }`}>
